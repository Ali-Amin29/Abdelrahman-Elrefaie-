                    ...
                    <div class="contact-form">
                        ...
                        <form action="{{ route('session') }}" method="get" name="sentMessage" id="contactForm" novalidate>
                            ...
                            <div class="control-group">
                                <input type="text" pattern="[A-Z a-z]+" style="width: 100%" class="form-control" name="name" id="name" placeholder="الاسم"
...
{{-- ------------------------------------------------------------ --}}
                            ...
                            <div class="control-group d-none mt-3" id="time">
                                <select class="form-control" name="time" aria-label="Default select example"
                                    ...
                                    <option value="50">15 دقيقه</option>
                                    <option value="2">30 دقيقه</option>
                                </select>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class=" mt-4">
                            ...
                            min="{{ now()->format('Y-m-d')}}"  max="2022-12-6">
